...
if (!output || !productVersion || !/^\d+\.\d+\.\d+$/.test(numericVersion ?? "") || !/^\d+$/.test(revision ?? "") || !/^(win|linux|osx)-[A-Za-z0-9-]+$/.test(rid ?? "") || !entrypoint || entrypoint.includes("\\") || entrypoint.split("/").some((part) => !part || part === "." || part === "..")) {
